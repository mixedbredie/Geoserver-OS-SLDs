      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="osmmsymbols/waterPointSymbol.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>1</Size>
            </Graphic>
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="osmmsymbols/landformDisusedSymbol.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>1</Size>
            </Graphic>
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:href="osmmsymbols/waterPointSymbol.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>1</Size>
            </Graphic>
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:href="osmmsymbols/pointSymbol.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>1</Size>
            </Graphic>

      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:href="osmmsymbols_gs/benchMarkSymbol_gs.svg"/>
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:href="osmmsymbols_gs/flowArrowSymbol_gs.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>1.75</Size>
              <Rotation>-
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:href="osmmsymbols_gs/culvertSymbol_gs.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>3</Size>
              <Rotation>-
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:href="osmmsymbols_gs/boundaryMereingChangeSymbol_gs.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>2</Size>
              <Rotation>-
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:href="osmmsymbols_gs/roadFlowSymbol_gs.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>1.75</Size>
              <Rotation>-
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:href="osmmsymbols_gs/railwaySwitchSymbol_gs.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>0.5</Size>
              <Rotation>-

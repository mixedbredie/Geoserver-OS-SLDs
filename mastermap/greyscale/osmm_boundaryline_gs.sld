...
xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.0.0/StyledLayerDescriptor.xsd">
  <NamedLayer>
    <Name>OS MasterMap&#174; Topography Layer - Administrative Boundaries Theme (greyscale style)</Name>
    <UserStyle>
      ...
      <FeatureTypeStyle>
        <Rule>
          <Name>County boundary - 1:35 to 1:4,175</Name>
          <ogc:Filter>
      ...
      <FeatureTypeStyle>
        <Rule>
          <Name>District boundary - 1:35 to 1:4,175</Name>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>osmmstyle_name</ogc:PropertyName>
      ...
      <FeatureTypeStyle>
        <Rule>
          <Name>Parliamentary boundary - 1:35 to 1:4,175</Name>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>osmmstyle_name</ogc:PropertyName>
      ...
      <FeatureTypeStyle>
        <Rule>
          <Name>Electoral boundary - 1:35 to 1:4,175</Name>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>osmmstyle_name</ogc:PropertyName>
      ...
      <FeatureTypeStyle>
        <Rule>
          <Name>Parish boundary - 1:35 to 1:4,175</Name>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>osmmstyle_name</ogc:PropertyName>
